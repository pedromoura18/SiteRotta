...
export const productsData: ProductItem[] = [
  ...
  },
  {
    ...
    brand: 'Honeywell',
    image: 'https://images.unsplash.com/photo-1580169980114-ccd0babfa840?auto=format&fit=crop&w=800&q=80',
  ...
  {
    id: 'prod-13',
    name: 'Access Point Ubiquiti UniFi U6',
    category: 'redes',
    ...
    description: 'Access point Wi-Fi 6 de alta performance da Ubiquiti para cobertura sem pontos cegos em ambientes corporativos densos, varejistas e hospitais.',
    features: ['Wi-Fi 6 (802.11ax) com velocidade de até 5,3 Gbps', 'Múltiplos SSIDs e VLAN para rede de visitantes', 'Gerenciamento centralizado via UniFi Controller', 'PoE injector incluso, sem necessidade de fonte separada'],
    badge: 'Wi-Fi 6',
  },
  {
    id: 'prod-14',
    name: 'Roteador MikroTik hEX RB750Gr3',
    category: 'redes',
    categoryLabel: 'Redes & Infraestrutura',
    brand: 'MikroTik',
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=800&q=80',
    description: 'Roteador compacto e poderoso com 5 portas Gigabit, firewall avançado e RouterOS para controle total do tráfego de rede da sua empresa.',
    features: ['5 portas Gigabit Ethernet', 'Firewall e controle de largura de banda por usuário', 'RouterOS com recursos de nível empresarial', 'Ideal para filiais, escritórios e pequenas operações'],
    badge: 'Firewall & Roteamento',
  },
]
